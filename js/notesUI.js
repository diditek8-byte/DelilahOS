...
export default class notesUI {
    constructor(root, { onNoteSelect, onNoteAdd, onNoteEdit, onNoteDelete} = {}) {
        ...
        <div class="windowbtnn" id="appheader">
                  ...
                  <p onclick="expandNotesWindow()" id="expand-notes" class="icon4"><i class="fa-solid fa-expand"></i></p>
               </div>
            <div class="sidebar">
            ...
            <div class="notes-text">
                <input class="notes-title" id="notes-title" type="text" placeholder="Enter your title">
                <textarea class="notes-body" id="notes-body" placeholder="write your thoughts..."></textarea>
            </div>`;
